    ...
    return (
        <div className="space-y-6 pb-20">
            ...
            <div className="bg-gray-800 p-4 rounded-xl space-y-4">
                <h3 className="text-lg font-bold text-[#DC2626] mb-2">Your Figures</h3>
                <div>
                    ...
                    <input
                        ...
                        className="w-full p-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-[#DC2626] focus:border-[#DC2626]"
                    />
                </div>
                ...
                <div className="flex items-center gap-3 pt-2">
                    <input
                        ...
                        className="h-5 w-5 rounded bg-gray-700 border-gray-600 text-[#DC2626] focus:ring-[#DC2626]"
                    />
            ...
            <div className="bg-gray-800 p-4 rounded-xl">
                <h3 className="text-lg font-bold text-[#DC2626] mb-4">Estimated Take-Home</h3>

                <div className="mb-4 p-4 bg-gray-700/50 rounded-xl border border-[#DC2626]/30 text-center">
                    <span className="text-xs font-medium text-[#DC2626]">Annual Net Income</span>
