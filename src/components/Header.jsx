            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 flex justify-between items-center">
                ...
                <div className="hidden md:flex items-center gap-6">
                    <nav className={`text-sm font-medium ${isScrolled ? 'text-gray-600' : 'text-gray-200'} flex gap-6`}>
                        ...
                        <a href="/service-plans" className="hover:text-accent transition-colors">Service Plans</a>
                        <a href="/finance" className="hover:text-accent transition-colors">Boiler Finance</a>
